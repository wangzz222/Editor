...
// 手动保存笔记修订版本
appRouter.post('/api/notes/:noteId/revision', noteController.saveNoteRevision)
// 手动保存所有笔记修订版本
appRouter.post('/api/notes/save-all-revisions', noteController.saveAllNotesRevisions)
// get note by id
